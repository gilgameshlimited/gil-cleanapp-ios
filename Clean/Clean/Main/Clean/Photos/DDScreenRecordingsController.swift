...
class DDScreenRecordingsController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    var isShortRecording: Bool = false
    ...
    func setupLocalization() {
        if self.isShortRecording {
            self.titleLab.text = DDlocal("DDShort_Recordings")
        } else {
            self.titleLab.text = DDlocal("DDScreen_Recordings")
        }
    ...
    func setupSubviews() {
        ...
        self.countLab.text = "\(self.screenArr.count) \(DDlocal("DDVideos"))"
